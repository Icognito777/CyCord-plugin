...
class Deadcord {
  ...
  getDescription() {
    return "A BetterDiscord plugin to interact with the Cycord Console";
  }
  getVersion() {
    return "0.5";
  }
  ...
  start() {
    ...
    console.log(
      "%cCycord v" + this.getVersion(),
      "color: #9a34ff; font-size: 60px; font-weight: bold; background: #222433; padding: 10px;"
    );
    console.log(
      "%cThe Cycord BD plugin has been loaded. Make sure the Cycord engine is running, otherwise, the plugin will not work.",
        ...
        async (error, response, body) => {
          if (parseFloat(body) > parseFloat(client_version)) {
            BdApi.showConfirmationModal(
              ...
              [
                `An update for the Cycord plugin is available. Updates are important and required to keep your Cycord working.`,
              ],
              {
                ...
                onConfirm: () => {
                  ...
                  BdApi.alert(
                    "Update Complete!",
                    "Your Cycord client should have updated to the latest version. If there are any issues, let us know."
                  );
                },
              }
            );
            ...
            BdApi.alert(
              "Up to Date!",
              "Your Cycord client is up to date. If you are looking for a update, wait a few minutes and try again."
            );
          }
        }
      );
